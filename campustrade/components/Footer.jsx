...
<footer className="bg-black sticky" id='foot'>
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 footer-main">
        <div className="sm:flex sm:items-center sm:justify-between  trademark">
         

            <a href="https://campus-trade-alpha.vercel.app/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
