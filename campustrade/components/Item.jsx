...
const Item = (props) => {
  ...
  return (
    <div className='min-w-[17vw] h-[45vh] bg-tranparent rounded-xl flex flex-col p-2 gap-2 flex-wrap justify-evenly text-white item hover:scale-105 transition duration-200 border-2 border-white'>
