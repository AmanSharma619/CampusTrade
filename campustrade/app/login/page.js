      ...
      <div className='left-div h-full w-full flex flex-col items-center justify-center gap-4' id='left'>
        {isSignup ? (
          <>
            ...
            <form className='w-4/5 min-h-3/5 flex flex-col gap-5 items-center justify-center '>
              <input type="text" className='bg-color2 w-4/5 h-10 rounded-2xl text-white p-1.5' placeholder='Name' />
              <input type="text" className='bg-color2 w-4/5 h-10 rounded-2xl text-white p-1.5' placeholder='Section' />
              <input type="text"  className='bg-color2 w-4/5 h-10 rounded-2xl text-white p-1.5' placeholder='Passing Year' />
              <input type="email" className='bg-color2 w-4/5 h-10 rounded-2xl text-white p-1.5' placeholder='Student Email' />
